...
import quotes.{QuotesManager,RealTimeQuote}
...
class QuotesActor extends Actor {
  ...
  //val nextTick = context.system.scheduler.schedule(Duration.Zero, 120000.millis, self, getTweets())
  ...
  //var quotes: RealTimeQuote = QuotesManager.fetchLatestQuotes
